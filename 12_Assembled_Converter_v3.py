...
class Converter:
    def __init__(self):
        ...
        self.help_button = Button(self.hist_help_btn_frame,
    ...
    def help(self):
        ...
        get_help.help_text.configure(text="Please enter a number in the box "
                                          "and then push on the buttons to "
...
class Help:
    def __init__(self, partner):
        ...
        self.help_heading = Label(self.help_frame, text="Help/Instructions",
                                  font="Candara 18 bold", fg="#3b5e3d",
                                  bg=background, pady=10)
        self.help_heading.grid(row=0)

        # Help text (label, row 1)
        self.help_text = Label(self.help_frame, text="", justify=LEFT,
                               width=40, bg=background, wrap=250, fg="#3b5e3d")
        self.help_text.grid(row=1)

        # Dismiss button (row 2)
        self.dismiss_btn = Button(self.help_frame, text="Dismiss",
                                  width=10, bg="#558757",  # green
